...
class TagopModel(nn.Module):
    ...
    def forward(self,
        ...
        table_tag_labels = util.replace_masked_values(tag_labels.float(), table_mask, -100)
        ...
        paragraph_tag_labels = util.replace_masked_values(tag_labels.float(), paragraph_mask, -100)
